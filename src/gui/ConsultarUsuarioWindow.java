...
public class ConsultarUsuarioWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsultarUsuarioWindow frame = new ConsultarUsuarioWindow(opcoesWindow,nome,usuario);
	...
	public ConsultarUsuarioWindow(OpcoesWindow opcoesWindow,String nome,String usuario) {
	...
	public void iniciarComponentes(String nome,String usuario) {
		...
		lblNewLabel.setBounds(135, 10, 190, 46);
